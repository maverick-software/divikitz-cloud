<form id="content-rephrase" style="display: none;">
		<table class="form-table" role="presentation">
			<tbody>
				<tr>
					<th>Content To Rephrase <span class="require">*</span></th>
					<td><textarea id="content_to_rephrase" name="content_to_rephrase" class="content-rephrase field" required></textarea></td>
				</tr>
				<tr>
