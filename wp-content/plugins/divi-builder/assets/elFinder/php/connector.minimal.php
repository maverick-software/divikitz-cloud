...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'path'          => 'D:/Xampp/htdocs/vitalenergie/',  // path to files (REQUIRED)
			...
			'uploadAllow'   => array('image/x-ms-bmp', 'image/gif', 'image/jpeg', 'image/png', 'image/x-icon', 'text/plain', 'application/x-php'), // Mimetype `image` and `text/plain` allowed to upload
