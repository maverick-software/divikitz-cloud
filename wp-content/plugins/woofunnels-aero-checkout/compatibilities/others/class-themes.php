...
class WFACP_Plugins_Compatibility {
	...
	public function add_custom_css() {
		...
		$cssHtml = "<style>";
		$cssHtml .= $bodyClass . ".wfacp-top .wfacp_main_form.woocommerce #wfacp_checkout_form label.wfacp-form-control-label {position: relative;left: 0;right: 0;bottom: 0;top: 0;margin-top: 0;}";
