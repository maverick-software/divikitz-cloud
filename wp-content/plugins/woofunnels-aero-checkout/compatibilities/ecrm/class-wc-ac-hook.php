...
class WFACP_WC_AC_Hook {
	...
	public function action() {
		$this->instance = WFACP_Common::remove_actions( 'woocommerce_after_order_notes', 'WC_AC_Hook', 'marketing_checkout_field' );
	}

	public function display_field( $field, $key ) {
		;
		if ( empty( $key ) || 'wc_ac_hook' !== $key || ! $this->instance instanceof WC_AC_Hook ) {
			return '';
		}
		?>
