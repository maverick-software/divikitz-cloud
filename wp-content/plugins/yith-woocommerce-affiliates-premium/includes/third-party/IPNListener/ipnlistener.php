...
class IpnListener {
    ...
    protected function curlPost($encoded_data) {
        ...
        /**
         * APPLY_FILTERS: yith_wcaf_ipn_listener_apply_custom_cainfo
         *
         * Filters whether to apply a custom certificate info in the IPN listener.
         *
         * @param bool $apply_custom_cainfo Whether to apply a custom certificate info in the IPN listener or not.
         */
        if ( apply_filters( 'yith_wcaf_ipn_listener_apply_custom_cainfo', true ) ) {
	        /**
             * APPLY_FILTERS: yith_wcaf_ipn_listener_custom_cainfo
             *
             * Filters the path for the custom certificate info in the IPN listener.
             *
             * @param string $custom_cainfo_path Custom certificate path.
             */
        ...
        /**
         * APPLY_FILTERS: yith_wcaf_ipn_listener_apply_custom_httpheader
         *
         * Filters whether to apply a custom header in the IPN listener.
         *
         * @param bool $apply_custom_httpheader Whether to apply a custom header in the IPN listener or not.
         */
	    if ( apply_filters( 'yith_wcaf_ipn_listener_apply_custom_httpheader', true ) ) {
		    /**
             * APPLY_FILTERS: yith_wcaf_ipn_listener_custom_httpheader
             *
             * Filters the custom HTTP header in the IPN listener.
             *
             * @param array $custom_httpheader Custom HTTP header.
             */
