<form id="linkedin-ad-headlines" style="display: none;">
	<table class="form-table" role="presentation">
		<tbody>
			<tr>
				<th>Product/Service Name <span class="require">*</span></th>
				<td><input type="text" id="product_name" name="product_name" class="google-ads field" placeholder="Name" required/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" id="target_keywords" name="target_keywords"  class="google-ads field" required/></td>
			</tr>
			<tr>
				<th>Promotion <span class="require">*</span></th>
				<td><input type="text" id="promotion" name="promotion"  class="google-ads field" required/></td>
			</tr>
		</tbody>
	</table>
</form>