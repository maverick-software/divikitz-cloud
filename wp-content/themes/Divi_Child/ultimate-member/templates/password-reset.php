			...
			<?php } else { ?>
				...
				<?php } else { ?>
					<div class="um-field um-field-block um-field-type_block">
						<div class="um-field-block">
							<div style="text-align:center;">
								<?php // _e( 'To reset HIiiiiiiiiiiii your password, please enter your email address or username below', 'ultimate-member' ); ?>
								<?php _e( "Enter your account's email and we'll send you an email to reset the password", 'ultimate-member' ); ?>
							</div>
						</div>
					</div>
				<?php }
				...
				<div class="um-col-alt um-col-alt-b">
					...
					<div class="um-center">
						<input type="submit" value="<?php esc_attr_e( 'Send Email', 'ultimate-member' ); ?>" class="um-button" id="um-submit-btn" />
					</div>
